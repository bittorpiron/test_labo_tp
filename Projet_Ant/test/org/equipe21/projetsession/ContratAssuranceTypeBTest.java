...
public class ContratAssuranceTypeBTest {

    ContratAssurance instance = new ContratAssuranceTypeB();

    
    public ContratAssuranceTypeBTest() {
    }
    ...
    public void testRemplirTableIndemnitesSoin0() {
        assertTrue(instance.indemnites.get(0).getPourcentage() == 50);
        assertEquals(instance.indemnites.get(0).getMontantMaximal(), new Dollar(40.00));
    }

    
    @Test
    public void testRemplirTableIndemnitesSoin100() {
        assertTrue(instance.indemnites.get(100).getPourcentage() == 50);
        assertEquals(instance.indemnites.get(100).getMontantMaximal(), new Dollar(50.00));
    }
    ...
    public void testRemplirTableIndemnitesSoin175() {
        assertTrue(instance.indemnites.get(175).getPourcentage() == 75);
    ...
    public void testRemplirTableIndemnitesSoin300() {
        assertTrue(instance.indemnites.get(300).getPourcentage() == 50);
    ...
    public void testRemplirTableIndemnitesSoin350() {
        assertTrue(instance.indemnites.get(350).getPourcentage() == 50);
    ...
    public void testRemplirTableIndemnitesSoin399() {
        assertTrue(instance.indemnites.get(399).getPourcentage() == 50);
    ...
    public void testRemplirTableIndemnitesSoin500() {
        assertTrue(instance.indemnites.get(500).getPourcentage() == 50);
        assertEquals(instance.indemnites.get(500).getMontantMaximal(), new Dollar(50.00));
    }
    ...
    public void testRemplirTableIndemnitesSoin700() {
        assertTrue(instance.indemnites.get(700).getPourcentage() == 70);
